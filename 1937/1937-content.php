                        ...
                        <div class="col-md-12">
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <img src="./images/3.jpg" alt="hinh3">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="./images/4.jpg" alt="hinh4">
                                    </div>
                                </div>
                                <!-- Add Pagination -->
                                        ...
                                        <div class="review-rating">
                                            ...
                                            <div class="stars">
                                                <form>
                                                    ...
                                                    <input class="star star-9" id="star-7" type="radio" name="star"/>
                                                    <label class="star star-9" for="star-7"></label>
                                                    <input class="star star-8" id="star-8" type="radio" name="star"/>
                                                    <label class="star star-8" for="star-8"></label>
                                                    <input class="star star-7" id="star-9" type="radio" name="star"/>
                                                    <label class="star star-7" for="star-9"></label>
                                                    <input class="star star-6" id="star-10" type="radio" name="star"/>
                                        ...
                                        <div class="review-rating">
                                            ...
                                            <div class="stars">
                                                <form>
                                                    ...
                                                    <label class="star star-9" for="star-13"></label>
                                                    <input class="star star-8" id="star-14" type="radio" name="star"/>
                                                    <label class="star star-8" for="star-14"></label>
                                                    <input class="star star-7" id="star-15" type="radio" name="star"/>
                                                    <label class="star star-7" for="star-15"></label>
                                                    <input class="star star-6" id="star-16" type="radio" name="star"/>
