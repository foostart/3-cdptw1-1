        ...
        <div class="container-fluid">
            <div class="tab">
                ...
                <div class="tab-content pt-4">
                    <div class="container tab-pane active" id="details" style="position: relative; overflow: hidden; height: 1076.47px; transition: height 250ms ease-out 0s;">
                        <div class="row">
                            <div class="col-md-12 col-12">
                                <p>
                                    <strong>Details Duis lobortis massa imperdiet quam</strong>
                                </p>
                    ...
                    <div class="container tab-pane fade" id="information" style="position: relative; overflow: hidden; height: 1076.47px; transition: height 250ms ease-out 0s;">
                        <table class="table-detail">
                            <tbody>
                                <tr>
                                    <th class="label" scope="col">Manufacturer</th>
                                    <td scope="col" class="data">Blue Stone</th>
                                </tr>
                                <tr class="table-items">
                                    <th class="label" scope="col">Pattern</th>
                                    <td scope="col" class="data">Solid</th>
                                </tr>
                                <tr>
                                    <th class="label" scope="col">Style</th>
                                    <td scope="col" class="data">Modern</th>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <div class="reviews">
                            <div class="review-title">
                                ...
                                <span class="review-author">
                                    ...
                                    <strong class="review-details-value">Vincent Joson</strong>
                                </span>
                                <span class="review-date">
                                    <span class="review-details-label">Posted on</span> 
                                    <time class="review-details-value">8/20/18</time>
                                </span>
                            </div>    
                            <div class="row">
                                    <div class="col-md-3">
                                ...
                                <div class="control">
                                    <div class="review-product">
                                        <div class="review-rating">
                                            ...
                                            <div class="vote-rating" style="padding-left: 33px;">
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
